            ...
            <div className="space-y-6">
              ...
              <div className="prose prose-lg text-gray-700 animate-fade-in delay-200">
                <p className="leading-relaxed">
                  Introduciendo nuestra línea comercial de productos para la construcción
                </p>
                <ul className="list-none pl-0 mt-6 space-y-3">
                  {[
                    "Suministros para la construcción de alta calidad",
                    "Bloques de hormigón o concreto",
                    "Impermeabilizantes para techos de construcciones industriales o domésticas",
                    "Cemento blanco o gris",
                    "Varillas para fundación hechas de acero de alta calidad"
                  ].map((feature, index) => (
