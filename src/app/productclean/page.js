            ...
            <div className="space-y-6">
              ...
              <div className="prose prose-lg text-gray-700 animate-fade-in delay-200">
                <p className="leading-relaxed">
                  Introduciendo nuestra linea de productos de aseo, domesticos e industriales
                </p>
                <ul className="list-none pl-0 mt-6 space-y-3">
                  {[
                    "Detergentes para el hogar y su espacio de trabajo",
                    "Todo tipo de jabones de uso doméstico para su aseo personal",
                    "Aromatizantes para el uso hogareño",
                    "Desinfectantes de superficie de uso doméstico e industrial",
                    "Todo tipo de utensilios para el aseo"
                  ].map((feature, index) => (
